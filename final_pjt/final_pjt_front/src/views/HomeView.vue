  ...
  <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="10000" @click.prevent="goToMap">
        <img src="../assets/img/illustrations/map.png" class="d-block w-100" alt="map">
      ...
      <div class="carousel-item" data-bs-interval="2000" @click.prevent="goToJoin">
        <img src="../assets/img/illustrations/AI.png" class="d-block w-100" alt="AI">
        <div class="carousel-caption d-none d-md-block">
          <h5>AI</h5>
      ...
      <div class="carousel-item"  @click.prevent="goToProduct">
        <img src="../assets/img/illustrations/product.png" class="d-block w-100" alt="product">
        <div class="carousel-caption d-none d-md-block">
          <br>
          <h5>금융 상품 찾아보기</h5>
